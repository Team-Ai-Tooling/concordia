...
- Reference platform engineering standards from `.concordia/standards/`
...
All product artifacts should be stored in appropriate `.concordia/` directories:
- Product requirements in `.concordia/prd/`
- Epic definitions in `.concordia/epics/`
- User stories in `.concordia/stories/`
- User research in `.concordia/discovery/`
